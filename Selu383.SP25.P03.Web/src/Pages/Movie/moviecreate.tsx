...
const MovieCreate: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (response.ok) {
      ...
      setError('Failed to create movie. Ensure all fields are filled out correctly.');
    }
  };
    ...
    <>
      ...
      <div>
        ...
        <div className="form-container">
          <h2 className="form-title">Create New Movie</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="submit-btn">Create Movie</button>
          </form>
        </div>
      </div>
    </>
